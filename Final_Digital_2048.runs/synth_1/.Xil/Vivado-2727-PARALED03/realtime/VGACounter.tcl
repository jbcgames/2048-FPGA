...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-2727-PARALED03/realtime/tmp"
    ...
    set rt::SDCFileList ./.Xil/Vivado-2727-PARALED03/realtime/VGACounter_synth.xdc
    rt::sdcChecksum
    set rt::top VGACounter
...
# MODE: 
    rt::set_parameter webTalkPath {/home/estudiante/Final_Digital_2048/Final_Digital_2048.cache/wt}
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-2727-PARALED03/"
