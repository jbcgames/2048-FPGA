...
--    
--  Modified: john.buitrago@udea.edu.co 2019
--            Version BASYS3 - ascci_new set by 100ms for each keyBoard press
--            Lines: 31, 77-99, 105
--------------------------------------------------------------------------------
...
ARCHITECTURE behavior OF ps2_keyboard_to_ascii IS
  ...
  signal tecla1: std_logic;
  signal tecla2: std_logic;
  ...
  END COMPONENT;
    ...
    signal sig_ascii_new : std_logic:='0';
BEGIN
  ...
  sec_1: process(clk)
  variable counter1sec: integer range 0 to 10000001:=0;
  variable st1: std_logic:='0';
  begin
    if(clk'EVENT AND clk = '1') then
        if st1='0' then
            ascii_new<='0';
            if sig_ascii_new = '1' then
               st1 :='1';
               ascii_new<='1';    
            end if;
        elsif st1='1' then
            if counter1sec = 10000000 then
                ascii_new<='0';
                counter1sec :=0;
                st1 :='0';
            else 
  ...
  BEGIN
    IF(clk'EVENT AND clk = '1') THEN
      ...
      sig_ascii_new <= '0';                                       --reset new ASCII code indicator
      CASE state IS
            ...
            ELSE --if control keys are not pressed  
              ...
              IF((shift_r = '0' AND shift_l = '0' AND caps_lock = '0') OR
                ...
                CASE ps2_code IS              
                  ...
                  WHEN x"32" => ascii <= x"62"; tecla1<='0'; tecla2<='1';--b
                  WHEN x"21" => ascii <= x"63"; tecla1<='1'; tecla2<='0';--c
